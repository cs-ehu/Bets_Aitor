...
public class Question implements Serializable {
	...
	public Question(Integer queryNumber, String query, Result result, float betMinimum, Event event,float cuota) {
		super(); 
		this.questionNumber = queryNumber;
		this.question = query;
		this.result=result;
	...
	public Question(String query, Result result, float betMinimum,float cuota,  Event event) {
		super();
		this.question = query;
		this.betMinimum=betMinimum;
		this.cuota=cuota;
